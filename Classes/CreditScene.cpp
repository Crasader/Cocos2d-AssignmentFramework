...
std::map<cocos2d::EventKeyboard::KeyCode,
	std::chrono::high_resolution_clock::time_point> CreditScene::Key_map;
...
//Scene* CreditScene::_createScene()
//{
...
Scene* CreditScene::_createScene_withSceneNode()
{
	auto scene_Node = Scene::createWithPhysics();
	auto layer = CreditScene::create();
	layer->set_SceneNode(scene_Node);
...
static void problemLoading(const char* filename)
{
	...
	printf("Depending on how you compiled you might have to add 'Resources/' in front of filenames in CreditSceneScene.cpp\n");
}
...
bool CreditScene::init()
{
	...
	m_listener->onMouseMove = CC_CALLBACK_1(CreditScene::onMouseMove, this);
	m_listener->onMouseUp = CC_CALLBACK_1(CreditScene::onMouseUp, this);
	m_listener->onMouseDown = CC_CALLBACK_1(CreditScene::onMouseDown, this);
	m_listener->onMouseScroll = CC_CALLBACK_1(CreditScene::onMouseScroll, this);
	...
	*/
	...
	//// add "CreditScene" splash screen"
	//auto sprite = Sprite::create("CreditScene.png");
	//if (sprite == nullptr)
	//{
	//    problemLoading("'CreditScene.png'");
	//}
	//else
	//{
...
void CreditScene::onKeyPressed(EventKeyboard::KeyCode keyCode, Event* event)
{
	...
	{
		//CCDirector::getInstance()->replaceScene(TransitionFade::create(0.5f, CreditScene::createScene(),Color3B(0,255,255)));
		//PlayerManager::getInstance().get_Player(0)->Shoot();		
	}
...
bool CreditScene::isKeyPressed(EventKeyboard::KeyCode code)
{
...
double CreditScene::keyPressedDuration(EventKeyboard::KeyCode code, bool seconds)
{
...
void CreditScene::onMouseMove(Event* event)
{
	EventMouse* e = (EventMouse*)event;
	e->getCursorX();
}
void CreditScene::onMouseDown(Event* event)
{
	EventMouse* e = (EventMouse*)event;
}
void CreditScene::onMouseUp(Event* event)
{
	EventMouse* e = (EventMouse*)event;
}
void CreditScene::onMouseScroll(Event* event)
{
	EventMouse* e = (EventMouse*)event;
}

bool CreditScene::checkBoxCollision(Sprite* box1, Sprite* box2)
{
