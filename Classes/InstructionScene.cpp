...
std::map<cocos2d::EventKeyboard::KeyCode,
	std::chrono::high_resolution_clock::time_point> InstructionScene::Key_map;
...
//Scene* InstructionScene::_createScene()
//{
...
Scene* InstructionScene::_createScene_withSceneNode()
{
	auto scene_Node = Scene::createWithPhysics();
	auto layer = InstructionScene::create();
	layer->set_SceneNode(scene_Node);
...
static void problemLoading(const char* filename)
{
	...
	printf("Depending on how you compiled you might have to add 'Resources/' in front of filenames in InstructionSceneScene.cpp\n");
}
...
bool InstructionScene::init()
{
	...
	bgMenu = Sprite::create("controlsBg.png");
	//bgNode->setAnchorPoint(Vec2::ZERO);
	...
	listener->onKeyReleased = CC_CALLBACK_2(InstructionScene::onKeyReleased, this);
	_eventDispatcher->addEventListenerWithSceneGraphPriority(listener, this);
#endif

#ifndef MOUSE_EVENT_INIT
	auto m_listener = EventListenerMouse::create();
	m_listener->onMouseMove = CC_CALLBACK_1(InstructionScene::onMouseMove, this);
	m_listener->onMouseUp = CC_CALLBACK_1(InstructionScene::onMouseUp, this);
	m_listener->onMouseDown = CC_CALLBACK_1(InstructionScene::onMouseDown, this);
	m_listener->onMouseScroll = CC_CALLBACK_1(InstructionScene::onMouseScroll, this);
	...
	*/
	...
	//// add "InstructionScene" splash screen"
	//auto sprite = Sprite::create("InstructionScene.png");
	//if (sprite == nullptr)
	//{
	//    problemLoading("'InstructionScene.png'");
	//}
	//else
	//{
...
void InstructionScene::update(float delta)
{
...
Scene* InstructionScene::get_SceneNode()
{
	return sceneNode;
}

void InstructionScene::onKeyPressed(EventKeyboard::KeyCode keyCode, Event* event)
{
	...
	{
		//CCDirector::getInstance()->replaceScene(TransitionFade::create(0.5f, InstructionScene::createScene(),Color3B(0,255,255)));
...
void InstructionScene::onKeyReleased(EventKeyboard::KeyCode keyCode, Event* event)
{
...
bool InstructionScene::isKeyPressed(EventKeyboard::KeyCode code)
{
...
double InstructionScene::keyPressedDuration(EventKeyboard::KeyCode code, bool seconds)
{
...
void InstructionScene::onMouseMove(Event* event)
{
	EventMouse* e = (EventMouse*)event;
	e->getCursorX();
}
void InstructionScene::onMouseDown(Event* event)
{
	EventMouse* e = (EventMouse*)event;
}
void InstructionScene::onMouseUp(Event* event)
{
	EventMouse* e = (EventMouse*)event;
}
void InstructionScene::onMouseScroll(Event* event)
{
	EventMouse* e = (EventMouse*)event;
}

bool InstructionScene::checkBoxCollision(Sprite* box1, Sprite* box2)
{
